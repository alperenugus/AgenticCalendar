...
import { Calendar, LogIn, Mail, Lock, User as UserIcon, Loader2, TrendingUp } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-lg">AI Calendar &amp; Markets Assistant</p>
        </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 flex items-center justify-center gap-2 text-xs text-slate-500">
            ...
            <span>Schedule events &amp; check live markets with AI</span>
          </div>
        </div>
